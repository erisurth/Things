...
It is parametric, so the outer diameter can easily be changed to suit different spool types.  I have included 37.5mm, 50mm, and 55mm exports below.

Instructions
------------

0. You may need to adjust the parameters and re-render the scad file before printing, depending on the internal diameter of your spool.
